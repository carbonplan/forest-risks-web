    ...
    <Box>
      <Box sx={sx.group}>
        ...
        <Text sx={sx.explanation}>
          Our biomass map shows an expected increase due to continued growth in
          existing forested areas. The degree of growth is based on models fit
          to historical data. Each line here shows a biomass growth curve from
          one of the plots within the selection.
        </Text>
        <Sparkline
      ...
      <Box sx={sx.group}>
        ...
        <Text sx={sx.explanation}>
          Risk scores along several dimensions represent threats to forest
          carbon permanence. Numbers here represent average risk, and the
          fraction of each donut shows the fraction of plots within the selected
          region where risk was above a threshold.
        </Text>
        <Grid columns={[3]}>
